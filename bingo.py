...
def save_data(player1_n, player2_n, winner):
    ...
    for i in range(len(lines)):
        ...
        if player1_n in line[i] and player2_n in line[i]:
            names_exist = True
            file.seek(i)
            line = lines[i]
            ...
            file.write(f"{player1_n}'s score: {player1_score}, {player2_n}'s score: {player2_score}")
            file.close()
            break
    ...
    if names_exist == False:
        ...
        if winner == 1:
            file.write(f"{player1_n}'s score: 1, {player2_n}'s score: 0")
        elif winner == 2:
            file.write(f"{player1_n}'s score: 0, {player2_n}'s score: 1")
        else:
            file.write(f"{player1_n}'s score: 0, {player2_n}'s score: 0")
